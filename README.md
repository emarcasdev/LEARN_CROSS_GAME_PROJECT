...
Abre la aplicación en un emulador de Android, simulador de iOS o en [Expo Go](https://expo.dev/go) *(la emulación en iOS solo se puede desde un Macbook o iPhone)*. La app se recargará automáticamente al modificar archivos.

* **Iniciar la app limpiando la caché**
